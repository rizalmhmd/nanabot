...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6281255642719', 'ᴹᴿ᭄ RiellXD ×፝֟͜×', 'Creator Bot', 'Creator Bot', true],
...
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, `${imgr + 'Verify'}`, [['JΛПƬΛП', '/verify'],['BΣƬIПΛ', '/verify']],m)
}    
