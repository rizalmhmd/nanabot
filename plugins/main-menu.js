 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya NanaBotz ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 NanaBotz..."},
	]
    },{
...
let tek = `    ⟪ *Yᴏᴜʀ Iɴғᴏ* ⟫ 
 
    ◉  𝐍𝐀𝐌𝐀 𝐋𝐔 :  *${await conn.getName(m.sender)}*
    ◉  𝐏𝐑𝐄𝐌𝐈𝐔𝐌 : *${usrs.premiumTime > 1 ? 'Yes': 'No'}* 
    ◉  𝐒𝐓𝐀𝐓𝐔𝐒 𝐋𝐔 : *${m.sender.split`@`[0] == nomorown ? 'Developer' : (usrs.premiumTime >= 1 ? 'Premium User' : 'Free User')}* 
    
    ⟪  𝐓𝐎𝐃𝐀𝐘  ⟫ 
    
    ◉ 𝐖𝐈𝐁: *${moment.tz('Asia/Jakarta').format('HH:mm:ss')}*
    ◉ 𝐖𝐈𝐓𝐀 : *${moment.tz('Asia/Makassar').format('HH:mm:ss')}*
    ◉ 𝐖𝐈𝐓 : *${moment.tz('Asia/Jayapura').format('HH:mm:ss')}*
    ◉ 𝐃𝐀𝐓𝐄 : *${new Date().toLocaleDateString()}*
    
    ⟪ 𝐃𝐀𝐓𝐀𝐁𝐀𝐒𝐄 ⟫ 
    
    ◉  𝐑𝐔𝐍𝐓𝐈𝐌𝐄 𝐁𝐎𝐓 : ${mpt}
    ◉  𝐑𝐄𝐆𝐈𝐒𝐓𝐄𝐑:  *${Object.keys(global.db.data.users).length}*
    ◉  𝐔𝐍𝐑𝐄𝐆: *${Object.values(global.db.data.users).filter(user => user.registered == true).length}*
    ◉  𝐎𝐃 𝐏𝐋𝐀𝐑𝐓𝐅𝐑𝐎𝐌 : *${os.platform()}*`
const listMessage = {
  text: tek,
  footer: '© 𝐍𝐀𝐍𝐀𝐁𝐎𝐓𝐙 | ALL RESERVED',
  mentions: await conn.parseMention(tek),
  title: ``,
  buttonText: `𝐌𝐄𝐍𝐔 𝐃𝐈𝐒𝐈𝐍𝐈 𝐊𝐎𝐍𝐓𝐎𝐋`,
  sections
}
  if (teks == '404') {
